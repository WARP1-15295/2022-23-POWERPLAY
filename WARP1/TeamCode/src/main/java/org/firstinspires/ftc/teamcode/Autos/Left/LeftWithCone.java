...
@Autonomous(name="Left Auto With Cone", group="Left")
//@Disabled
public class LeftWithCone extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            robotMap.strafeRunToDistance(34.0, 0.5,3.0);
            sleep(1000);
            robotMap.liftForTime(0.6, 4.0);
            sleep(500);
